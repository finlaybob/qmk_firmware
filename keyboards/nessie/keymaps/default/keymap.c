...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ADJ] = LAYOUT(
        _______,    BL_STEP,_______, _______,_______,_______,_______,     _______,   _______, _______,_______,   QK_BOOT,
        _______,    _______,_______, _______,_______,_______,_______,     _______,   _______, _______,OSL(_CFG), _______,
    ...
    [_CFG] = LAYOUT(
        _______,   CUSTOM_P,   _______,     _______,    _______, _______, _______, _______, _______, _______,_______, _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_LWR] = { ENCODER_CCW_CW(KC_UP, KC_DOWN) },
